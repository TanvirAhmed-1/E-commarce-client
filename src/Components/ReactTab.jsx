  ...
  return (
    <div>
        <div className="flex justify-center items-center">
          <h1 className="text-2xl pt-10  md:text-start text-center font-semibold text-black">Find Your Products</h1>
        </div>
      <Tabs selectedIndex={tabIndex} onSelect={(index) => setTabIndex(index)}>
        <TabList className=" lg:w-10/12 mx-auto grid md:grid-cols-6 grid-cols-3 md:py-20 py-10 justify-center items-center gap-4">
          ...
          <Tab><div className="grid justify-center items-center">
           ...
           <img src={img1} className="w-20 h-20 rounded-full object-center" alt="" srcset="" />
           </div>
          ...
          <div className="grid justify-center items-center">
           <div className="bg-gray-300 rounded-full p-[2px]">
           <img src={img3} className="w-20 h-20 rounded-full object-center" alt="" srcset="" />
           </div>
          ...
          <div className="grid justify-center items-center">
           <div className="bg-gray-300 rounded-full p-[2px]">
           <img src={img2} className="w-20 h-20 rounded-full" alt="" srcset="" />
           </div>
            <p className="text-black text-center text-lg font-semibold ">Fashion</p>
            </div>
          </Tab>
          <Tab>
          <div className="grid justify-center items-center">
           <div className="bg-gray-300 rounded-full p-[2px]">
           <img src={img4} className="w-20 h-20 rounded-full" alt="" srcset="" />
           </div>
          ...
          <div className="grid justify-center items-center">
           <div className="bg-gray-300 rounded-full p-[2px]">
           <img src={img6} className="w-20 h-20 rounded-full" alt="" srcset="" />
           </div>
          ...
          <div className="grid justify-center items-center">
           <div className="bg-gray-300 rounded-full p-[2px]">
           <img src={img5} className="w-20 h-20 rounded-full" alt="" srcset="" />
           </div>
