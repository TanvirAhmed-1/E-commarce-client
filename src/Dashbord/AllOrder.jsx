    ...
    return (
        <div className="min-h-screen bg-gray-100 px-8">
            <div className="max-w-full mx-auto bg-white p-6 rounded-xl shadow-lg">
                <h1 className="text-3xl font-bold text-center text-gray-800 mb-6">User Orders</h1>
                        ...
                        {payment?.map((order, index) => (
                            <React.Fragment key={order._id}>
                                <tr className="border-t text-black border-b">
                                    ...
                                    <td className="py-2 px-4">
                                        <button
                                            ...
                                            className={`${activeShippingId === order._id ? "bg-green-300 text-black  " :" btn-sm bg-blue-500 text-white"} px-2 py-2 border-none  rounded-lg`}
                                        >
                                ...
                                {/* {activeShippingId === order._id && (
                                    <tr>
                                        <td colSpan="7" className="p-4 bg-gray-100 text-gray-800">
                                            <div>
                                                <h3 className="text-lg font-semibold mb-1">Shipping Information</h3>
